...
/*
Strafe distance calibration sketch
...
5. Robot waits for strafe commands:
...
bool prepareAtWall()
{
  ...
  preparedAtWall = true;
  Serial.println(F("[READY] Wall prep complete. Enter l### or r###."));
...
{
  Serial.println();
  Serial.println(F("=== Strafe Time Test Commands ==="));
...
void setup()
{
  ...
  Serial.println(F("AMR strafe time test sketch"));
